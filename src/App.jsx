...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-100 flex items-center justify-center">
      <div className="w-full max-w-3xl mx-auto p-6 rounded-2xl shadow-2xl bg-white/90 border border-gray-200">
        <h1 className="text-4xl font-extrabold text-center text-blue-700 mb-8 tracking-tight drop-shadow">Dev Toolbox</h1>
...
function JsonHistory() {
  ...
  return (
    <div className="space-y-4">
      <h2 className="text-2xl font-bold text-blue-700 mb-2 text-center">JSON History</h2>
          ...
          {history.map((item) => (
            <div key={item.id} className="border border-gray-200 rounded-lg p-4 bg-white shadow-sm">
              ...
              <div className="mb-2">
                ...
                <pre className="bg-gray-200 p-2 rounded text-xs overflow-x-auto mt-1 font-mono">{item.original}</pre>
              </div>
              <div>
                <span className="font-semibold text-gray-700">Formatted:</span>
                <pre className="bg-gray-100 p-2 rounded text-xs overflow-x-auto mt-1 font-mono">{item.formatted}</pre>
              </div>
            </div>
          ))}
        </div>
